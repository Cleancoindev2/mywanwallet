            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on MyEtherWallet.com or view your transactions on [wanscan.io](https://wanscan.io), you are seeing data on the blockchain, not in our personal systems.
                </li>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_secure_1_content__3">
                  Always check the URL: `https://mywanwallet.nl`.
                </li>
