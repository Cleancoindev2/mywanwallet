<section class="pre-footer">
  <div class="container">
    <p>
      MyWanWallet.nl does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <p>
        <span translate="FOOTER_1">
          Free, open-source, client-side interface for generating Wanchain wallets &amp; more. Interact with the Wanchain blockchain easily &amp; securely. Double-check the URL ( mywanwallet.nl ) before unlocking your wallet.
        </span>
      </p>
    ...
    <section class="footer--righ">
      ...
      <p>
        <a aria-label="support email" href="mailto:support@mywanwallet.nl" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Email support: support@mywanwallet.nl
        </a>
      </p>
      <p>
        <a href="https://mywanwallet.nl/signmsg.html" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Sign Message
        </a>
      </p>

      <p>
        <a aria-label="website via github URL" href="https://github.com/TyrionShared/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          github.com/TyrionShared
        </a>
      </p>
      ...
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/tyrion70" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/TyrionShared" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="support email" title="support email" href="mailto:support@mywanwallet.nl" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
