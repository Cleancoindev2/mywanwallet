...
NODE_Warning: 'Your node must be HTTPS in order to connect to it via MyWanWallet.nl. You can [download the MyWanWallet repo & run it locally](https://github.com/TyrionShared/mywanwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
HELP_2b_Desc_1: 'Go to [https://github.com/TyrionShared/mywanwallet/releases/latest](https://github.com/TyrionShared/etherwallet/releases/latest).',
...
HELP_8_Desc_4: 'In addition, the likelihood of us taking MyWanWallet down is slim to none. It costs us almost nothing to maintain as we aren\'t storing any information. If we do take the domain down, it still is, and always will be, publicly available at [https://github.com/TyrionShared/mywanwallet](https://github.com/TyrionShared/mywanwallet). You can download the ZIP there and run it locally.',
...
HELP_Sec_Desc_4: 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/TyrionShared/mywanwallet/releases/latest](https://github.com/TyrionShared/etherwallet/releases/latest) to [https://www.MyWanWallet.nl](https://www.MyWanWallet.nl).',
HELP_Sec_Desc_5: 'For generating wallets, you can download the [source code and run it locally](https://github.com/TyrionShared/mywanwallet/releases/latest). See #5 above.',
